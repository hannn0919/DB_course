            ...
            <div class="card" >
                ...
                <div class="card-body" style = "max-height:552px;overflow:scroll;" >
                    ...
                    @foreach($array_data['exps'] as $key => $d)
                            <div class = "card" style="width: 100%;height: auto;">
                                <div class="card-header"><h3>{{$d->CourseNo}}</h3><br></div> 
                                <div class = "card-body">
                                    <p style="overflow: hidden; white-space:nowrap; background-color: #e0e0e0; color: black; text-decoration:none;">{{$d->Additional}}</p>
                                    <p style="background-color: #e0e0e0; color: black; text-decoration:none;">{{$d->Account}}</p>
                                </div>
                            </div>
                        @endforeach
